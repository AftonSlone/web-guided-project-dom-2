...
const launch =
  ...
  (e) => {
    ...
    document.querySelector(".success").classList.add("off");
    document.querySelector(".failure").classList.add("off");
  });
...
const confirm =
  ...
  (e) => {
    ...
    document.querySelector(".success").classList.remove("off");
  });
...
const cancel =
  ...
  (e) => {
    document.querySelector(".modal").classList.add("off");
    document.querySelector(".failure").classList.remove("off");
  });
